...
public class ShowCreatePageInfoTab extends ContentPanel {
    ...
    protected void onInitData() {
        ...
        this.schedule_value = LocalDate.now().toDate();
        Date now = new Date();
        ...
        this.start_at_value = LocalTime.parse(numberFormat.format(hour) + ":" + numberFormat.format(minute) + ":00", formatter).toDateTimeToday().toDate();
