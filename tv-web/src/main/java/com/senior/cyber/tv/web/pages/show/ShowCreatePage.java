...
@Bookmark("/show/create")
@AuthorizeInstantiation({Role.NAME_ROOT, Role.NAME_ShowCreatePage})
public class ShowCreatePage extends MasterPage {
    ...
    protected void onInitData() {
        super.onInitData();
        this.info_tab = new Tab("info", "Show Info", ShowCreatePageInfoTab.class);
    }
